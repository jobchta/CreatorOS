...
export const HeroSection: FC<HeroSectionProps> = () => {
  return (
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
      ...
      {/* BACKGROUND ORBS
        These use the classes from globals.css to float around
      */}
        ...
        <div className="glass-card inline-flex flex-wrap items-center justify-center gap-8 p-6 md:p-8 reveal delay-400 border-white/5">
          ...
          <div className="flex items-center gap-4">
            <div className="flex -space-x-3">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="w-10 h-10 rounded-full border-2 border-[#0a0a0f] bg-slate-800 flex items-center justify-center text-xs font-bold"
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              ...
              <div className="text-gray-500 text-xs uppercase tracking-wider font-medium mt-1">Rating</div>
            </div>
          </div>
        </div>
